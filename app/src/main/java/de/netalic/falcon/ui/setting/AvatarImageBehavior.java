...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public AvatarImageBehavior(
        ...
        if (attrs != null) {
            ...
            mFinalXPosition = a.getDimension(R.styleable.AvatarImageBehavior_finalXPosition, 0);
            ...
            mFinalToolbarHeight = a.getDimension(R.styleable.AvatarImageBehavior_finalToolbarHeight, 0);
            a.recycle();
        }
    }
