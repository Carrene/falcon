...
public class SendConfirmationPresenter implements SendConfirmationContract.Presenter {

    private SendConfirmationContract.View mSendConfirmationView;

    public SendConfirmationPresenter(SendConfirmationContract.View transferConfirmationView) {
