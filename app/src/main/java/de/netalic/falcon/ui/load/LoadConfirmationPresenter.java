...
public class LoadConfirmationPresenter implements LoadConfirmationContract.Presenter {

    private final LoadConfirmationContract.View mChargeConfirmationView;
    ...
    public LoadConfirmationPresenter(LoadConfirmationContract.View chargeConfirmationView) {
