...
public class LoadFailedFragment extends Fragment implements LoadFailedContract.View {

    private LoadFailedContract.Presenter mChargeFailedPresenter;
    ...
    @Override
    public void setPresenter(LoadFailedContract.Presenter presenter) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRoot = inflater.inflate(R.layout.fragment_loadfailed, null);
    ...
    public static LoadFailedFragment newInstance(Receipt receipt) {
