...
public class NavigationDrawerUtil {
    ...
    public static Drawer getDrawer(final Activity activity, Toolbar toolbar, int identifier) {
        ...
        PrimaryDrawerItem item8 = new CustomPrimaryDrawerItem().withIdentifier(8).withName(R.string.navigation_chart).withIcon(R.drawable.navigation_chart);
        PrimaryDrawerItem item9 = new CustomPrimaryDrawerItem().withIdentifier(9).withName(R.string.navigation_setting).withIcon(R.drawable.navigation_setting);
        PrimaryDrawerItem item10 = new CustomPrimaryDrawerItem().withIdentifier(10).withName(R.string.navigation_help).withIcon(R.drawable.navigation_help);
